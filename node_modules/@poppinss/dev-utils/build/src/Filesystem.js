 ...
 */
class Filesystem {
    constructor(basePath = (0, path_1.join)((0, os_1.tmpdir)(), `${new Date().getTime()}`)) {
     ...
     */
    isModule(filePath) {
        return ['.js', '.ts', '.json'].includes((0, path_1.extname)(filePath));
    }
    /**
     * Makes abs path to a given file
     */
    makePath(filePath) {
        return (0, path_1.isAbsolute)(filePath) ? filePath : (0, path_1.join)(this.basePath, filePath);
    }
    /**
    ...
    removeFromModulesCache(filePath) {
         ...
         */
        try {
            (0, clear_module_1.default)(absPath);
        }
        catch (error) { }
